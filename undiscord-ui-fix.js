// ==UserScript==
// @name            Undiscord
// @description     Delete all messages in a Discord channel or DM (UI & Trash bin Fixed)
// @version         5.2.6-fixed
// @author          victornpb
// @homepageURL     https://github.com/qvsix/undiscord_fix
// @supportURL      https://github.com/qvsix/undiscord_fix/discussions
// @match           https://*.discord.com/app
// @match           https://*.discord.com/channels/*
// @match           https://*.discord.com/login
// @license         MIT
// @namespace       https://github.com/qvsix/undiscord_fix
...
// @downloadURL     https://github.com/qvsix/undiscord_fix/raw/master/deleteDiscordMessages.user.js
// @updateURL       https://github.com/qvsix/undiscord_fix/raw/master/deleteDiscordMessages.user.js
// ==/UserScript==
(function () {
  'use strict';

  // -- ADDED TRUSTED TYPES BYPASS --
...
#undiscord, #undiscord * {
  ...
  --background-secondary: #313338;
  --background-tertiary: #2b2d31;
  ...
  --button-positive-background: #23a559;
  --text-muted: #a3a6aa;
  ...
  --bg-overlay-2: #2b2d31;
  --__header-bar-background: #2b2d31;
...
`;
  ...
  const HOME = 'https://github.com/s7w49zhbnt-hue/undiscord_fix';
